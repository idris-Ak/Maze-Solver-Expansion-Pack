...
void printTeamInfo(void){
    ...
    std::cout << "\t [1] Abdullah Abdosh (s4007967@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [2] Idris Aklan (s4003401@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [3] Mohammed Ahtesh (s4006644@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [4] Ravindu Dias (s4046373@student.rmit.edu.au)" << std::endl;
    //*************
